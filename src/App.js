...
function App() { //pass the custombtn text to the custombtn.js component 
      ...
      <ThemeProvider theme = {theme}>
        ...
        <div className={classes.wrapper}>
          <Typography variant="h4" className={classes.bigSpace} color="primary">
             My name is Dean Quach and this is my website
          </Typography>
        ...
        <div className={`${classes.grid} ${classes.bigSpace}`}> {/*new classes using a template string*/}
